...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="fek_io",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6fek_io11AppDelegate")
...
SWIFT_CLASS("_TtC6fek_io19SampleSchemeHandler")
@interface SampleSchemeHandler : NSObject <WKURLSchemeHandler>
...
SWIFT_CLASS("_TtC6fek_io14ViewController")
